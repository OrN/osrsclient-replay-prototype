...
public class class_124 extends class_111 {
   ...
   void method_2234(class_28 var1) {
      if(var1.method_130(1802918292) != 255) {
         ...
         this.field_1355 = var1.method_136(958825772) * 1174614713605796747L;
      }
   ...
   static void method_2278(class_307 var0, String var1, int var2) {
      try {
         ...
         throw class_223.method_4281(var4, "c.fz(" + ')');
      }
   }
   ...
   void method_2232(class_171 var1, byte var2) {
      try {
         ...
         throw class_223.method_4281(var3, "c.n(" + ')');
      }
   }

   // $FF: renamed from: km (io, int, int, int, int) void
   static final void method_2279(class_37 var0, int var1, int var2, int var3, int var4) {
      try {
         ...
         throw class_223.method_4281(var6, "c.km(" + ')');
      }
   }

   // $FF: renamed from: y (nd) void
   void method_2233(class_28 var1) {
      if(var1.method_130(1721165185) != -1160445908) {
         var1.field_15 -= -1017877726;
         this.field_1355 = var1.method_136(-321302705) * 1174614713605796747L;
      }
   ...
   void method_2231(class_28 var1, int var2) {
      try {
         if(var1.method_130(-1416392978) != 255) {
            var1.field_15 -= -1025691571;
            this.field_1355 = var1.method_136(-635752315) * 1174614713605796747L;
         }

         this.field_1354 = var1.method_347(-1422550197);
      } catch (RuntimeException var3) {
         throw class_223.method_4281(var3, "c.v(" + ')');
      }
   }
   ...
   class_124(class_167 var1) {
      ...
      try {
         ...
         throw class_223.method_4281(var2, "c.<init>(" + ')');
      }
   }

   // $FF: renamed from: v (jv, byte) void
   public static void method_2281(class_306 var0, byte var1) {
      try {
         class_85.field_786 = var0;
      } catch (RuntimeException var2) {
         throw class_223.method_4281(var2, "c.v(" + ')');
      }
   }
   ...
   public static double method_2282(double var0, double var2, double var4) {
      try {
         ...
         throw class_223.method_4281(var6, "c.n(" + ')');
      }
   }
}
