...
public class class_279 {
   ...
   // $FF: renamed from: u jv
   public static class_306 field_3227;
   // $FF: renamed from: n short[][]
   public static final short[][] field_3228;
   // $FF: renamed from: f short[]
   public static final short[] field_3229;
   // $FF: renamed from: y short[][]
   public static final short[][] field_3230;
   // $FF: renamed from: g int
   public static final int field_3231 = 0;
   // $FF: renamed from: v short[]
   public static final short[] field_3232;
   ...
   public static boolean method_5152(char var0, int var1) {
      try {
         if(var0 >= 32) {
            if(var1 <= 1949224493) {
               throw new IllegalStateException();
