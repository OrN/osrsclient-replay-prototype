...
public class class_43 extends class_27 {
   ...
   static final int method_492(int var0, int var1, int var2, int var3) {
      try {
         int var4 = var0 / var2;
         int var5 = var0 & var2 - 1;
         int var6 = var1 / var2;
         int var7 = var1 & var2 - 1;
         int var8 = class_247.method_4714(var4, var6, (byte)106);
         int var9 = class_247.method_4714(var4 + 1, var6, (byte)106);
         int var10 = class_247.method_4714(var4, var6 + 1, (byte)113);
         int var11 = class_247.method_4714(1 + var4, 1 + var6, (byte)116);
         int var13 = 65536 - class_70.field_559[var5 * 1024 / var2] >> 1;
         int var12 = (var8 * (65536 - var13) >> 16) + (var13 * var9 >> 16);
         int var14 = class_154.method_3248(var10, var11, var5, var2, (byte)-61);
         int var16 = 65536 - class_70.field_559[1024 * var7 / var2] >> 1;
         int var15 = (var14 * var16 >> 16) + (var12 * (65536 - var16) >> 16);
         return var15;
      } catch (RuntimeException var17) {
         throw class_223.method_4281(var17, "ge.s(" + ')');
      }
   }
   ...
   class_43(int var1, byte[] var2) {
      ...
      try {
         ...
         for(var4 = 0; var4 < this.field_310 * -1780750535; ++var4) {
            this.field_312[var4] = var3.method_130(1791737604);
         }

         for(var4 = 0; var4 < -1780750535 * this.field_310; ++var4) {
            this.field_313[var4] = new int[var3.method_130(360114416)];
         }

         for(var4 = 0; var4 < this.field_310 * -1780750535; ++var4) {
            for(int var5 = 0; var5 < this.field_313[var4].length; ++var5) {
               this.field_313[var4][var5] = var3.method_130(-1876794022);
            }
         }

      } catch (RuntimeException var6) {
         throw class_223.method_4281(var6, "ge.<init>(" + ')');
      }
   }
   ...
   static void method_495(int var0, class_280 var1, boolean var2, int var3) {
      try {
         class_230 var4 = class_46.method_534((byte)7).method_6356(var0, -1848369284);
         ...
         throw class_223.method_4281(var9, "ge.ay(" + ')');
      }
   }

   // $FF: renamed from: v (int, int) int
   public static int method_496(int var0, int var1) {
      try {
         ...
         throw class_223.method_4281(var7, "ge.v(" + ')');
      }
   }
}
