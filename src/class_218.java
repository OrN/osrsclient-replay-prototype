...
public abstract class class_218 {
   ...
   boolean method_4204(int var1, int var2) {
      class_237 var3 = this.method_4206();
   ...
   public abstract int method_4205();

   // $FF: renamed from: f (int) fv
   abstract class_237 method_4206();

   // $FF: renamed from: y (int) int
   abstract int method_4207();
   ...
   boolean method_4210(int var1, int var2, int var3) {
      try {
         if(!this.method_4209(244885152)) {
            ...
            class_75 var4 = class_116.method_2248(this.method_4205(), 1647125333);
            int var5 = this.method_4207();
            int var6 = this.method_4228();
   ...
   boolean method_4211(int var1, int var2, int var3) {
      try {
         class_237 var4 = this.method_4206();
         if(null == var4) {
            if(var3 != 280751135) {
               throw new IllegalStateException();
            } else {
   ...
   boolean method_4217(int var1, int var2) {
      if(!this.method_4209(1845144120)) {
         ...
         class_75 var3 = class_116.method_2248(this.method_4205(), 1647125333);
         int var4 = this.method_4207();
         int var5 = this.method_4228();
