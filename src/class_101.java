...
public class class_101 extends class_59 {
   ...
   static final int field_1177 = 7;
   // $FF: renamed from: cd int
   public static final int field_1178 = 99;
   ...
   public static final int field_1185 = 61;
   // $FF: renamed from: c int
   static final int field_1186 = 8192;
   ...
   final boolean method_1885() {
      if(class_357.field_3980 == this.field_1173) {
         this.method_1897((byte)125);
      }

      return this.field_1173 == class_357.field_3979;
   }
   ...
   // $FF: renamed from: d (int, java.lang.String, java.lang.String, java.lang.String) void
   void method_1891(int var1, String var2, String var3, String var4) {
      int var5 = (class_197.field_2337 += 300746265) * 543094313 - 1;
      this.field_1183 = var5 * -1719880919;
      this.field_1174 = client.field_1425 * 612436449;
      this.field_1175 = var1 * 626007683;
      this.field_1180 = var2;
      this.method_1884(1824375293);
      ...
      this.field_1181 = var4;
      this.method_1907(1400910895);
      this.method_1890(1778308212);
   }

   // $FF: renamed from: s (int, java.lang.String, java.lang.String, java.lang.String) void
   void method_1892(int var1, String var2, String var3, String var4) {
      int var5 = (class_197.field_2337 += 300746265) * 543094313 - 1;
      this.field_1183 = var5 * -1719880919;
      this.field_1174 = client.field_1425 * 612436449;
      this.field_1175 = var1 * 626007683;
   ...
   void method_1894(int var1, String var2, String var3, String var4) {
      int var5 = (class_197.field_2337 += 300746265) * 543094313 - 1;
      this.field_1183 = var5 * -1719880919;
      this.field_1174 = client.field_1425 * 612436449;
      this.field_1175 = var1 * 626007683;
   ...
   final boolean method_1896() {
      if(class_357.field_3980 == this.field_1173) {
         this.method_1897((byte)103);
      }
   ...
   // $FF: renamed from: u (int, java.lang.String, java.lang.String, java.lang.String) void
   void method_1902(int var1, String var2, String var3, String var4) {
      int var5 = (class_197.field_2337 += 1493301119) * 412222323 - 1;
      this.field_1183 = var5 * -1719880919;
      this.field_1174 = client.field_1425 * 612436449;
      this.field_1175 = var1 * 626007683;
      this.field_1180 = var2;
   ...
   final boolean method_1906() {
      if(this.field_1179 == class_357.field_3980) {
         this.method_1889((byte)-70);
      }

      return class_357.field_3979 == this.field_1179;
   }
