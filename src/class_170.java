...
public class class_170 {
   ...
   class_28 method_3622() {
      ...
      var1.method_210(-437407307 * field_2124);
      var1.method_210(this.field_2117?1:0);
      var1.method_210(this.field_2118?1:0);
      var1.method_210(this.field_2119 * 1694107947);
      var1.method_210(this.field_2126.size());
      Iterator var2 = this.field_2126.entrySet().iterator();

      while(var2.hasNext()) {
         Entry var3 = (Entry)var2.next();
         var1.method_116(((Integer)var3.getKey()).intValue());
         var1.method_116(((Integer)var3.getValue()).intValue());
      }

      var1.method_120(this.field_2120 != null?this.field_2120:"");
      var1.method_250(this.field_2123, (short)-4710);
      var1.method_210((int)(100.0D * this.field_2128));
      var1.method_210(this.field_2122 * 1285356667);
      var1.method_210(1286486299 * this.field_2121);
      var1.method_210(-1768933319 * this.field_2115);
      return var1;
   }
   ...
   class_28 method_3627() {
      ...
      var1.method_210(this.field_2117?1:0);
      var1.method_210(this.field_2118?1:0);
      var1.method_210(this.field_2119 * -660685365);
      var1.method_210(this.field_2126.size());
      Iterator var2 = this.field_2126.entrySet().iterator();
      ...
      var1.method_210((int)(100.0D * this.field_2128));
      var1.method_210(this.field_2122 * 1285356667);
      var1.method_210(-140834991 * this.field_2121);
      var1.method_210(-1768933319 * this.field_2115);
      return var1;
   }
