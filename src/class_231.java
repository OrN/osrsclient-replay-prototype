      ...
      try {
         ...
         if(!var1) {
            ...
            if(!var1) {
               ...
               if(!client.field_1476) {
                  ...
                  for(var32 = 0; var32 < var2; ++var32) {
                     ...
                     if(var33 != null) {
                        ...
                        class_46.method_536(-1808857292);
                        class_251 var7 = GameSocket.field_2401;
                              ...
                              for(var12 = 0; var12 < class_275.field_3216.length; ++var12) {
                                 ...
                                 if(var11 == class_275.field_3216[var12]) {
                                    ...
                                    if(null != class_168.field_2103[var12]) {
                                       ...
                                       FontHandler.method_6614(class_168.field_2103[var12], var32, 8 * var4, 8 * var5, var36, 8 * (var40 & 7), 8 * (var10 & 7), var38, GameSocket.field_2401, client.field_1475, 305716239);
                                       break;
                                    }
                                 }
                              }
               ...
               class_46.method_536(-1808857292);
               class_120.method_2266(GameSocket.field_2401, client.field_1475, -1580902995);
               ...
               if(class_121.field_1337.method_2439((byte)-45)) {
                  ...
                  var41 = class_112.newPacket(ClientOpcode.OPCODE_11, client.field_1463.isaac, (byte)8);
               ...
               var41 = class_112.newPacket(ClientOpcode.OPCODE_97, client.field_1463.isaac, (byte)8);
               client.field_1463.method_4079(var41);
   ...
   void method_4434(Buffer var1, boolean var2, int var3) {
      try {
         ...
         for(int var5 = 0; var5 < var4; ++var5) {
            ...
            class_219 var10001 = new class_219((class_280)null, var7, var6, (class_237)null);
            var11.add(var10001);
         }
                  ...
                  while(true) {
                     ...
                     if(0 == var8) {
                        if(0 == var1) {
                           ...
                           int var14 = class_43.method_492(var12 + '\ub135', var13 + 91923, 4) - 128 + (class_43.method_492(10294 + var12, '\u93bd' + var13, 2) - 128 >> 1) + (class_43.method_492(var12, var13, 1) - 128 >> 2);
