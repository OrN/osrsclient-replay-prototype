...
public class class_107 extends class_104 {
   ...
   // $FF: renamed from: cq (boolean) void
   public synchronized void method_2066(boolean var1) {
      this.field_1243 = (this.field_1243 ^ this.field_1243 >> -305202438) + (this.field_1243 >>> 31);
      if(var1) {
   ...
   public synchronized int method_2067() {
      return this.field_1242 < 0?-1:this.field_1242;
   }

   // $FF: renamed from: en (int, int, byte[], int[], int, int, int, int, int, int, int, bv, int, int) int
   static int method_2068(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, class_107 var11, int var12, int var13) {
   ...
   // $FF: renamed from: es (int, int, byte[], int[], int, int, int, int, int, int, int, int, int, bv, int, int) int
   static int method_2079(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, class_107 var13, int var14, int var15) {
   ...
   // $FF: renamed from: er (int, int, byte[], int[], int, int, int, int, int, int, int, int, int, bv, int, int) int
   static int method_2086(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, class_107 var13, int var14, int var15) {
      var13.field_1252 -= var13.field_1254 * var5;
   ...
   // $FF: renamed from: ca (int[], int, int, int, int) int
   int method_2097(int[] var1, int var2, int var3, int var4, int var5) {
      while(true) {
         if(this.field_1253 > 0) {
            int var6 = var2 + this.field_1253;
            if(var6 > var4) {
   ...
   public synchronized void method_2103(int var1) {
      this.method_2077(var1 << 6, this.method_2183());
   }
   ...
   // $FF: renamed from: by (int) void
   synchronized void method_2106(int var1) {
      this.method_2077(var1, this.method_2183());
   }
   ...
   static int method_2109(int var0, int var1) {
      return var1 < 0?var0:(int)((double)var0 * Math.sqrt((double)(16384 - var1) * 1.220703125E-4D) + 0.5D);
   }

   // $FF: renamed from: bz (int, int) int
   static int method_2110(int var0, int var1) {
      return var1 < 0?var0:(int)((double)var0 * Math.sqrt((double)(16384 - var1) * 1.220703125E-4D) + 0.5D);
   }

   // $FF: renamed from: bh (int, int) int
   static int method_2111(int var0, int var1) {
      return var1 < 0?var0:(int)((double)var0 * Math.sqrt((double)(16384 - var1) * 1.220703125E-4D) + 0.5D);
   }

   // $FF: renamed from: bs (int, int) int
   static int method_2112(int var0, int var1) {
   ...
   public synchronized void method_2119(int var1) {
      this.method_2077(var1 << 6, this.method_2183());
   }
   ...
   public synchronized void method_2121(int var1) {
      this.field_1249 = var1;
   }

   // $FF: renamed from: bi (int) void
   public synchronized void method_2122(int var1) {
      this.field_1249 = var1;
   }

   // $FF: renamed from: bb (int) void
   public synchronized void method_2123(int var1) {
      this.method_2077(var1 << 6, this.method_2183());
   }
   ...
   // $FF: renamed from: du (int, int, byte[], int[], int, int, int, int, int, int, int, bv, int, int) int
   static int method_2125(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, class_107 var11, int var12, int var13) {
      if(var12 == 0 || (var8 = var5 + (var10 - var4 + var12 - 257) / var12) > var9) {
         var8 = var9;
      }
   ...
   // $FF: renamed from: bc (int, int) void
   synchronized void method_2127(int var1, int var2) {
      this.field_1245 = var1;
      this.field_1242 = var2;
      this.field_1253 = 0;
      this.method_2073();
   ...
   public synchronized int method_2128() {
      return this.field_1242 < 0?-1:this.field_1242;
   }
   ...
   public synchronized void method_2130(int var1) {
      int var2 = ((class_110)this.field_1205).field_1266.length << 8;
      if(var1 < -1) {
         var1 = -1;
      }
   ...
   // $FF: renamed from: ec (byte[], int[], int, int, int, int, int, int, int, bv) int
   static int method_2131(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, class_107 var9) {
      var2 >>= 8;
      var8 >>= 8;
      var4 <<= 2;
      var5 <<= 2;
   ...
   public synchronized void method_2132(int var1) {
      int var2 = ((class_110)this.field_1205).field_1266.length << 8;
      if(var1 < -1) {
         var1 = -1;
      }
   ...
   // $FF: renamed from: ct (boolean) void
   public synchronized void method_2133(boolean var1) {
      this.field_1243 = (this.field_1243 ^ this.field_1243 >> 31) + (this.field_1243 >>> 296725815);
      if(var1) {
         this.field_1243 = -this.field_1243;
      }
   ...
   // $FF: renamed from: dl (int, int, byte[], int[], int, int, int, int, int, int, bv, int, int) int
   static int method_2134(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, class_107 var10, int var11, int var12) {
      if(var11 == 0 || (var7 = var5 + (var9 + 256 - var4 + var11) / var11) > var8) {
         var7 = var8;
      }
      ...
      while(var5 < var7) {
         ...
         byte var13 = var2[var1 - 1];
         var10001 = var5++;
         var3[var10001] += ((var13 << 8) + (var2[var1] - var13) * (var4 & -442119827)) * var6 >> 6;
         var4 += var11;
      }
   ...
   // $FF: renamed from: cp (int) void
   public synchronized void method_2135(int var1) {
      int var2 = ((class_110)this.field_1205).field_1266.length << 8;
      if(var1 < -1) {
         var1 = -1;
      }
   ...
   public synchronized void method_2137(int var1, int var2) {
      this.method_2195(var1, var2, this.method_2183());
   }

   // $FF: renamed from: cs (int, int, int) void
   public synchronized void method_2138(int var1, int var2, int var3) {
      if(var1 == 0) {
   ...
   public synchronized void method_2139(int var1, int var2, int var3) {
      if(var1 == 0) {
         this.method_2077(var2, var3);
      } else {
         int var4 = method_2108(var2, var3);
   ...
   public synchronized void method_2140(int var1) {
      if(var1 == 0) {
         this.method_2076(0);
         this.method_108();
      } else if(this.field_1247 == 0 && this.field_1248 == 0) {
   ...
   public synchronized void method_2141(int var1) {
      if(var1 == 0) {
         this.method_2076(0);
         this.method_108();
      } else if(this.field_1247 == 0 && this.field_1248 == 0) {
   ...
   public synchronized void method_2143(int var1) {
      if(this.field_1243 < 0) {
   ...
   public boolean method_2144() {
      return this.field_1244 < 0 || this.field_1244 >= ((class_110)this.field_1205).field_1266.length << 8;
   }

   // $FF: renamed from: cz () boolean
   public boolean method_2145() {
      return this.field_1244 < 0 || this.field_1244 >= ((class_110)this.field_1205).field_1266.length << 8;
   }

   // $FF: renamed from: cr (boolean) void
   public synchronized void method_2146(boolean var1) {
      this.field_1243 = (this.field_1243 ^ this.field_1243 >> 31) + (this.field_1243 >>> 31);
      if(var1) {
         this.field_1243 = -this.field_1243;
      }
   ...
   public boolean method_2148() {
      return this.field_1253 != 0;
   }

   // $FF: renamed from: dp (int, int, byte[], int[], int, int, int, int, int, int, int, bv, int, int) int
   static int method_2149(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, class_107 var11, int var12, int var13) {
      if(var12 == 0 || (var8 = var5 + (var10 + 256 - var4 + var12) / var12) > var9) {
         var8 = var9;
      }
   ...
   // $FF: renamed from: cx (int[], int, int, int, int) int
   int method_2150(int[] var1, int var2, int var3, int var4, int var5) {
      while(true) {
         if(this.field_1253 > 0) {
            int var6 = var2 + this.field_1253;
            if(var6 > var4) {
   ...
   public synchronized void method_2151(int var1) {
      if(var1 == 0) {
         this.method_2076(0);
         this.method_108();
      } else if(this.field_1247 == 0 && this.field_1248 == 0) {
   ...
   public boolean method_2152() {
      return this.field_1244 < 0 || this.field_1244 >= ((class_110)this.field_1205).field_1266.length << 8;
   }

   // $FF: renamed from: cw (int[], int, int, int, int) int
   int method_2153(int[] var1, int var2, int var3, int var4, int var5) {
      while(true) {
         if(this.field_1253 > 0) {
            int var6 = var2 + this.field_1253;
            if(var6 > var4) {
   ...
   public boolean method_2156() {
      return this.field_1253 != 0;
   }

   // $FF: renamed from: dr (byte[], int[], int, int, int, int, int, int, bv) int
   static int method_2157(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, class_107 var8) {
      var2 >>= 8;
      var7 >>= 8;
      var4 <<= 2;
      if((var5 = var3 + var7 - var2) > var6) {
   ...
   // $FF: renamed from: di (byte[], int[], int, int, int, int, int, int, bv) int
   static int method_2158(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, class_107 var8) {
      var2 >>= 8;
      var7 >>= 8;
      var4 <<= 2;
      if((var5 = var3 + var7 - var2) > var6) {
   ...
   // $FF: renamed from: br (int, int) int
   static int method_2160(int var0, int var1) {
      return var1 < 0?-var0:(int)((double)var0 * Math.sqrt((double)var1 * 1.220703125E-4D) + 0.5D);
   }
   ...
   // $FF: renamed from: do (byte[], int[], int, int, int, int, int, int, bv) int
   static int method_2162(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, class_107 var8) {
      var2 >>= 8;
      var7 >>= 8;
      var4 <<= 2;
      if((var5 = var3 + var2 - (var7 - 1)) > var6) {
   ...
   // $FF: renamed from: dm (int, int, byte[], int[], int, int, int, int, int, int, int, bv, int, int) int
   static int method_2165(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, class_107 var11, int var12, int var13) {
      if(var12 == 0 || (var8 = var5 + (var10 + 1014590976 - var4 + var12) / var12) > var9) {
         var8 = var9;
      }
      ...
      for(var8 <<= 1; var5 < var8; var4 += var12) {
         var1 = var4 >> 8;
         byte var14 = var2[var1 - 1];
         var0 = (var14 << 8) + (var2[var1] - var14) * (var4 & -1912716630);
         var10001 = var5++;
         var3[var10001] += var0 * var6 >> 6;
         var10001 = var5++;
         var3[var10001] += var0 * var7 >> 6;
      ...
      for(var1 = var13; var5 < var8; var4 += var12) {
         var0 = (var1 << 8) + (var2[var4 >> 8] - var1) * (var4 & 1811432188);
         var10001 = var5++;
         var3[var10001] += var0 * var6 >> 6;
         var10001 = var5++;
         var3[var10001] += var0 * var7 >> 6;
   ...
   // $FF: renamed from: dg (int, int, byte[], int[], int, int, int, int, int, int, int, bv, int, int) int
   static int method_2169(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, class_107 var11, int var12, int var13) {
      if(var12 == 0 || (var8 = var5 + (var10 - var4 + var12 - 632175743) / var12) > var9) {
         var8 = var9;
      }
      ...
      for(var8 <<= 1; var5 < var8; var4 += var12) {
         var1 = var4 >> 8;
         var14 = var2[var1];
         var0 = (var14 << 8) + (var2[var1 + 1] - var14) * (var4 & 928312510);
         var10001 = var5++;
         var3[var10001] += var0 * var6 >> 6;
         var10001 = var5++;
         var3[var10001] += var0 * var7 >> 6;
   ...
   // $FF: renamed from: ds (byte[], int[], int, int, int, int, int, int, bv) int
   static int method_2170(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, class_107 var8) {
      var2 >>= 8;
      var7 >>= 8;
      var4 <<= 2;
      if((var5 = var3 + var2 - (var7 - 1)) > var6) {
   ...
   // $FF: renamed from: dn (int, int, byte[], int[], int, int, int, int, int, int, int, bv, int, int) int
   static int method_2172(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, class_107 var11, int var12, int var13) {
      if(var12 == 0 || (var8 = var5 + (var10 - var4 + var12 - 257) / var12) > var9) {
         var8 = var9;
      }
   ...
   // $FF: renamed from: dh (int, int, byte[], int[], int, int, int, int, int, int, int, bv, int, int) int
   static int method_2173(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, class_107 var11, int var12, int var13) {
      if(var12 == 0 || (var8 = var5 + (var10 - var4 + var12 - 257) / var12) > var9) {
         var8 = var9;
      }
   ...
   // $FF: renamed from: dq (int, int, byte[], int[], int, int, int, int, int, int, bv, int, int) int
   static int method_2175(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, class_107 var10, int var11, int var12) {
      if(var11 == 0 || (var7 = var5 + (var9 + 256 - var4 + var11) / var11) > var8) {
         var7 = var8;
      }
   ...
   // $FF: renamed from: de (int, int, byte[], int[], int, int, int, int, int, int, bv, int, int) int
   static int method_2176(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, class_107 var10, int var11, int var12) {
      if(var11 == 0 || (var7 = var5 + (var9 + 256 - var4 + var11) / var11) > var8) {
         var7 = var8;
      }
   ...
   // $FF: renamed from: dt (int, int, byte[], int[], int, int, int, int, int, int, int, bv, int, int) int
   static int method_2177(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, class_107 var11, int var12, int var13) {
      if(var12 == 0 || (var8 = var5 + (var10 - var4 + var12 - -1921514758) / var12) > var9) {
         var8 = var9;
      }
      ...
      for(var8 <<= 1; var5 < var8; var4 += var12) {
         var1 = var4 >> 8;
         var14 = var2[var1];
         var0 = (var14 << 8) + (var2[var1 + 1] - var14) * (var4 & -581839321);
         var10001 = var5++;
         var3[var10001] += var0 * var6 >> 6;
         var10001 = var5++;
         var3[var10001] += var0 * var7 >> 6;
   ...
   // $FF: renamed from: dw (byte[], int[], int, int, int, int, int, int, int, bv) int
   static int method_2179(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, class_107 var9) {
      var2 >>= 8;
      var8 >>= 8;
      var4 <<= 2;
      var5 <<= 2;
   ...
   // $FF: renamed from: ea (byte[], int[], int, int, int, int, int, int, int, bv) int
   static int method_2181(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, class_107 var9) {
      var2 >>= 8;
      var8 >>= 8;
      var4 <<= 2;
      var5 <<= 2;
   ...
   // $FF: renamed from: em (int, int, byte[], int[], int, int, int, int, int, int, int, bv, int, int) int
   static int method_2188(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, class_107 var11, int var12, int var13) {
      var11.field_1247 -= var11.field_1255 * var5;
      var11.field_1248 -= var11.field_1256 * var5;
      if(var12 == 0 || (var8 = var5 + (var10 + 1833533173 - var4 + var12) / var12) > var9) {
         var8 = var9;
      }
   ...
   // $FF: renamed from: dj (byte[], int[], int, int, int, int, int, int, bv) int
   static int method_2190(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, class_107 var8) {
      var2 >>= 8;
      var7 >>= 8;
      var4 <<= 2;
      if((var5 = var3 + var7 - var2) > var6) {
   ...
   // $FF: renamed from: eb (int, int, byte[], int[], int, int, int, int, int, int, int, int, int, bv, int, int) int
   static int method_2191(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, class_107 var13, int var14, int var15) {
      var13.field_1252 -= var13.field_1254 * var5;
      if(var14 == 0 || (var10 = var5 + (var12 - var4 + var14 - 257) / var14) > var11) {
         var10 = var11;
      }
   ...
   // $FF: renamed from: ef (int, int, byte[], int[], int, int, int, int, int, int, int, bv, int, int) int
   static int method_2194(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, class_107 var11, int var12, int var13) {
      var11.field_1247 -= var11.field_1255 * var5;
      var11.field_1248 -= var11.field_1256 * var5;
      if(var12 == 0 || (var8 = var5 + (var10 + 256 - var4 + var12) / var12) > var9) {
         var8 = var9;
      ...
      while(var5 < var8) {
         ...
         byte var14 = var2[var1 - 1];
         var10001 = var5++;
         var3[var10001] += ((var14 << 8) + (var2[var1] - var14) * (var4 & 1160004622)) * var6 >> 6;
         var6 += var7;
         var4 += var12;
      }
      ...
      for(var1 = var12; var5 < var8; var4 += var1) {
         var10001 = var5++;
         var3[var10001] += ((var0 << 8) + (var2[var4 >> 8] - var0) * (var4 & 321783402)) * var6 >> 6;
         var6 += var7;
      }
   ...
   // $FF: renamed from: cl (int[], int, int, int, int) int
   int method_2196(int[] var1, int var2, int var3, int var4, int var5) {
      while(true) {
         if(this.field_1253 > 0) {
            int var6 = var2 + this.field_1253;
            if(var6 > var4) {
   ...
   // $FF: renamed from: ey (int, int, byte[], int[], int, int, int, int, int, int, int, int, int, bv, int, int) int
   static int method_2197(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, class_107 var13, int var14, int var15) {
      var13.field_1252 -= var13.field_1254 * var5;
      if(var14 == 0 || (var10 = var5 + (var12 + 256 - var4 + var14) / var14) > var11) {
         var10 = var11;
      }
