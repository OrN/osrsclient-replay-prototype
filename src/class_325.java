...
public class class_325 implements class_14 {
   ...
   class_325(int var2, class_336[] var3) {
      super();
      try {
               ...
               try {
                  ...
                  while(true) {
                     ...
                     if(var7 == 4) {
                        ...
                        var10 = var3[var5++] << 16;
                        var10 += var3[var5++];
                        var11 = class_71.method_1047(var10);
                        var12 = var3[var5++];
                        if(-1 != var12) {
                           if(var2 <= 388871013) {
                              throw new IllegalStateException();
                     ...
                     if(14 == var7) {
                        ...
                        var10 = var3[var5++];
                        var8 = class_43.method_496(var10);
                     }
   ...
   static final class_369 method_5781(Buffer var0, class_369 var1, int var2) {
      try {
         ...
         if(var1 == null) {
            ...
            var4 = class_100.method_1845(var3);
