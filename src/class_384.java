...
final class class_384 implements class_23 {
   ...
   public void method_71(Object var1, class_28 var2) {
      this.method_6702((Integer)var1, var2, (byte)53);
   }

   // $FF: renamed from: b (java.lang.Integer, nd, byte) void
   void method_6702(Integer var1, class_28 var2, byte var3) {
      try {
         var2.method_116(var1.intValue(), 940009950);
      } catch (RuntimeException var4) {
         throw class_223.method_4281(var4, "no.b(" + ')');
      }
   }
   ...
   public Object method_75(class_28 var1, int var2) {
      try {
         return Integer.valueOf(var1.method_135((byte)-103));
      } catch (RuntimeException var3) {
         throw class_223.method_4281(var3, "no.n(" + ')');
      }
   }

   // $FF: renamed from: d (java.lang.Integer, nd) void
   void method_6703(Integer var1, class_28 var2) {
      var2.method_116(var1.intValue(), -1605861998);
   }
