...
public class class_385 implements class_14 {
   ...
   public static void method_6708(Object var0, class_28 var1, int var2) {
      try {
         class_23 var3 = method_6712(var0.getClass(), (short)-2594);
         var3.method_73(var0, var1, 510448708);
      } catch (RuntimeException var4) {
         throw class_223.method_4281(var4, "np.j(" + ')');
      }
   }
   ...
   void method_6709(int var1, int var2, Class var3, class_23 var4) {
      try {
         ...
         throw class_223.method_4281(var5, "np.<init>(" + ')');
      }
   }

   // $FF: renamed from: y (int) np[]
   public static class_385[] method_6710(int var0) {
      try {
         return new class_385[]{field_4218, field_4215, field_4216};
      } catch (RuntimeException var1) {
         throw class_223.method_4281(var1, "np.y(" + ')');
      }
   }

   // $FF: renamed from: v (ax, byte) ai
   public static class_1 method_6711(class_144 var0, byte var1) {
      try {
         ...
         throw class_223.method_4281(var2, "np.v(" + ')');
      }
   }
   ...
   static class_23 method_6712(Class var0, short var1) {
      try {
         ...
         throw class_223.method_4281(var3, "np.r(" + ')');
      }
   }
   ...
   public static class_385 method_6713(Class var0, byte var1) {
      try {
         class_385[] var2 = method_6710(-72158502);
         ...
         throw class_223.method_4281(var5, "np.p(" + ')');
      }
   }

   // $FF: renamed from: b (nd, int) java.lang.Object
   public Object method_6714(class_28 var1, int var2) {
      try {
         return this.field_4220.method_75(var1, -1954872085);
      } catch (RuntimeException var3) {
         throw class_223.method_4281(var3, "np.b(" + ')');
      }
   }
   ...
   public static void method_6716(Object var0, class_28 var1) {
      ...
      var2.method_73(var0, var1, -634871930);
   }
   ...
   public static class_385 method_6718(Class var0) {
      class_385[] var1 = method_6710(631352557);
   ...
   public static void method_6721(Object var0, class_28 var1) {
      ...
      var2.method_73(var0, var1, -1911884618);
   }
}
